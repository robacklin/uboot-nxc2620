...
$(U_BOOT_NAND):	$(NAND_SPL) $(obj)u-boot.bin
		cat $(obj)nand_spl/u-boot-spl.bin > $(obj)u-boot-nand.bin
		dd if=$(obj)u-boot.bin of=$(obj)u-boot-nand.bin bs=1k seek=4
...
nxc2600_dvb2_config: unconfig
	@echo "#define CONFIG_NXC2600_DVB 2" > $(obj)include/config.h
	@echo "#define CONFIG_NXC2620" >> $(obj)include/config.h
	@echo "#include <configs/nxc2600.h>" >> $(obj)include/config.h
	@$(MKCONFIG) -a nxc2600 mips mips nxc2600 icnexus

nxc2600_dvb3_nand_config: unconfig
	@mkdir -p $(obj)include
	@mkdir -p $(obj)nand_spl
	@mkdir -p $(obj)board/icnexus/nxc2600
	@echo "#define CONFIG_NXC2600_DVB 3" > $(obj)include/config.h
	@echo "#define CONFIG_NXC2620" >> $(obj)include/config.h
	@echo "#define CONFIG_NAND_U_BOOT" >> $(obj)include/config.h
	@echo "#include <configs/nxc2600.h>" >> $(obj)include/config.h
	@echo "Compile NAND boot image for nxc2600 dvb3"
	@$(MKCONFIG) -a nxc2600 mips mips nxc2600 icnexus
	@echo "TEXT_BASE = 0x83f01000" > $(obj)board/icnexus/nxc2600/config.tmp
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk


nxc2600_dvb2_nand_config:    unconfig
	@mkdir -p $(obj)include
	@mkdir -p $(obj)nand_spl
	@mkdir -p $(obj)board/icnexus/nxc2600
	@echo "#define CONFIG_NXC2600_DVB 2" > $(obj)include/config.h
	...
	@echo "#define CONFIG_NAND_U_BOOT" >> $(obj)include/config.h
	@echo "#include <configs/nxc2600.h>" >> $(obj)include/config.h
	@echo "Compile NAND boot image for nxc2600 dvb2"
	@$(MKCONFIG) -a nxc2600 mips mips nxc2600 icnexus
	@echo "TEXT_BASE = 0x83f01000" > $(obj)board/icnexus/nxc2600/config.tmp
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
